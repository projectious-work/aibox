...
**Status:** completed (verified 2026-04-18: aibox.lock = 0.18.5 / processkit v0.18.1; team-creator skill present; .claude/settings.json hook commands use $CLAUDE_PROJECT_DIR; AGENTS.md non-empty; all template snapshot dirs exist incl. v0.18.1)
