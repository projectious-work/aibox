...
!!! tip "Manual download"
    If you prefer to download manually from the [releases page](https://github.com/projectious-work/dev-box/releases), each tarball (e.g., `dev-box-v0.3.1-aarch64-apple-darwin.tar.gz`) contains a single binary named `dev-box-v0.3.1-aarch64-apple-darwin`. After extracting, rename it to `dev-box` and move it to a directory in your `PATH`:

    ```bash
    tar xzf dev-box-v0.3.1-aarch64-apple-darwin.tar.gz
    mv dev-box-v0.3.1-aarch64-apple-darwin ~/.local/bin/dev-box
